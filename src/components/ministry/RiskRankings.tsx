...
export function RiskRankings({
  ...
  return (
    <section id="risk-rankings" className="grid grid-cols-1 gap-6 lg:grid-cols-2 scroll-mt-6">
            ...
            <li key={d.district} className="flex items-center justify-between gap-3 py-2">
              <div className="flex items-center gap-2.5 min-w-0">
                ...
                <div className="min-w-0">
                  <p className="truncate text-sm text-slate-800">{d.district}</p>
      ...
      <div className="rounded-lg border border-slate-200 bg-white p-4">
        <h3 className="text-sm font-semibold text-navy-950">Highest-Risk Contractors</h3>
        <p className="mt-1 text-xs text-slate-500">
              ...
              <div className="flex items-center gap-2.5 min-w-0">
                ...
                <div className="min-w-0">
                  <Link
                    ...
                    className="truncate text-sm text-navy-700 hover:underline block"
                  >
                    {c.companyName}
                  </Link>
