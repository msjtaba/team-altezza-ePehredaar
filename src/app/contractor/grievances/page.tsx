...
export default async function GrievancesPage({
  ...
  return (
    <div className="flex flex-col gap-10">
      <div>
        <h1 className="text-3xl font-semibold text-navy-950">Grievances</h1>
      ...
      <section className="rounded-lg border border-slate-200 bg-white p-6">
        <h2 className="text-lg font-semibold text-navy-950">File a new grievance</h2>
        <form action={fileGrievance} className="mt-4 flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            <label htmlFor="alertId" className="text-sm font-medium text-slate-700">
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="evidenceUrl" className="text-sm font-medium text-slate-700">
      ...
      <section>
        <h2 className="text-xl font-semibold text-navy-950">Your grievances</h2>
        {grievances.length === 0 ? (
          ...
          <div className="mt-4 flex flex-col gap-4">
            {grievances.map((g) => (
              <div key={g.id} className="rounded-lg border border-slate-200 bg-white p-5">
                <div className="flex flex-wrap items-start justify-between gap-2">
                  <div>
                    <p className="text-sm text-navy-950">{g.description}</p>
                    {g.alert && (
