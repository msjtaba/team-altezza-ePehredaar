// Real data — data.md §1, "Allocated Limit for Hon'ble MPs" (543 MPs).
// Validated: sum reconciles with the source PDF's stated grand total of
// ₹8,335.21 Cr. Tuple shape: [srNo, state, name, constituency, amountCr | null].
// null = tracker.md decision #1 (Sr. No. 108, documented source gap —
// shown as "Not available in source", never fake-filled).

export type MpRow = [number, string, string, string, number | null];

export const MPS_REAL: MpRow[] = [
  ...
  [108, "Maharashtra", "CHAVAN VASANTRAO BALWANTRAO", "NANDED", null],
